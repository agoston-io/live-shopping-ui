...
GRANT select ON users TO agoston_anonymous, agoston_person;
...
CREATE INDEX ON live_shopping_ui.channels(user_id);
GRANT select ON channels TO agoston_anonymous, agoston_person;
...
GRANT select ON broadcasts TO agoston_anonymous, agoston_person;
...
GRANT select ON chats TO agoston_anonymous, agoston_person;
GRANT insert (broadcast_id, content) ON chats TO agoston_anonymous, agoston_person;
GRANT USAGE ON SEQUENCE chats_id_seq TO agoston_anonymous, agoston_person;
...
GRANT select ON products TO agoston_anonymous, agoston_person;
