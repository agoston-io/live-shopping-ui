  ...
  <nav class="navbar navbar-expand-lg navbar-dark b-2">
    <div class="container-fluid">
      <div class="navbar-brand me-5">
        <div>
          <router-link :to="{ name: 'LandingPage' }">Live shopping UI</router-link>
        </div>
        <div class="ms-4" style="margin-top: -10px">
          ...
          <a target="blank" href="https://agoston.io">
            <img src="@/assets/img/logo_horizontal_x300.png" alt="" width="60" />
          </a>
        </div>
      </div>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-3 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link text-light" aria-current="page" href="https://github.com/niolap/live-shopping-ui"
              target="_blank"><font-awesome-icon :icon="['fab', 'github']" /> Fork me</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" aria-current="page" href="https://picsum.photos/"
              target="_blank"><font-awesome-icon :icon="['fas', 'photo-video']" /> Media
              generated by Picsum</a>
          </li>
        </ul>
        <div v-if="!$agostonClient.isAuthenticated()">
          <router-link class="fw-bold" :to="{ name: 'LoginPage' }">login</router-link>
        </div>
        <div v-else>
